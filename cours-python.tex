...
\include{24_avoir_plus_la_classe_avec_les_objets}
\include{tex/25_tkinter}
\clearpage
\input{tex/26_remarques_complementaires}
\input{tex/26_remarques_complementaires_vrac}
\clearpage
\input{tex/27_mini_projets_descriptions}
\input{tex/27_mini_projets_pas_a_pas}
