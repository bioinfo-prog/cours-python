...
\include{tex/24_tkinter}
\clearpage
\input{tex/25_remarques_complementaires}
\input{tex/25_remarques_complementaires_vrac}
\clearpage
\input{tex/26_mini_projets_descriptions}
\input{tex/26_mini_projets_pas_a_pas}
