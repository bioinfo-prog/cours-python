...
\include{tex/18_modules_interet_bioinfo}
\include{tex/19_jupyter}
\include{tex/20_avoir_la_classe_avec_les_objets}
\include{tex/21_tkinter}
\clearpage
\input{tex/22_remarques_complementaires}
\input{tex/22_remarques_complementaires_vrac}
\clearpage
\input{tex/23_mini_projets_descriptions}
\input{tex/23_mini_projets_pas_a_pas}
