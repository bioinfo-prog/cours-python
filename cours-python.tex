...
\fancyfoot[RE,LO]{\it Cours de Python / Université de Paris / UFR Sciences du Vivant}
...
\includegraphics[width=8cm]{img/logo_Univ_Paris.png}
...
\include{tex/13_dictionnaires_tuples_sets}
...
\clearpage
\input{tex/21_remarques_complementaires}
\input{tex/21_remarques_complementaires_vrac}
\clearpage
\input{tex/22_mini_projets_descriptions}
\input{tex/22_mini_projets_pas_a_pas}
